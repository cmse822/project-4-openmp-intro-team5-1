// Part 1 Q2 Script with OpenMP - compiling commands are at the bottom of script
#include <iostream>
#include <fstream>
#include <vector>
#include <random>
...
// for this script, we'll compile as: 'g++ -fopenmp -o Part_1_Q_2_withopenmp Part_1_Q_2_withopenmp.cpp'
// then we'll specify the thread count: 'export OMP_NUM_THREADS=1'
// run with: './Part_1_Q_2_withopenmp'
